  ...
  useEffect(() => {
    const fetchMyProducts = async () => {
      ...
      if (response.data?.getAllMyProducts) {
        setMyProducts(
          response.data.getAllMyProducts.products as Array<Product>
        );
      ...
      <div className="bg-body-light border-bottom">
        <div className="content py-1 text-center">
          <nav className="breadcrumb bg-body-light py-2 mb-0">
            <a className="breadcrumb-item" href="be_pages_ecom_dashboard.html">
              e-Commerce
            </a>
            ...
            <a className="block block-rounded block-link-shadow">
              <div className="block-content block-content-full block-sticky-options">
                ...
                <div className="py-3 text-center">
                  <div className="fs-2 fw-bold mb-0 text-info">
                    {availableProductsCount + outOfStockProductsCount}
                  </div>
          ...
          <div className="col-md-6 col-xl-3">
            <a className="block block-rounded block-link-shadow">
              <div className="block-content block-content-full block-sticky-options">
                ...
                <div className="py-3 text-center">
                  <div className="fs-2 fw-bold mb-0 text-warning">
        ...
        <div className="content-heading d-flex justify-content-between align-items-center">
          ...
          <div className="space-x-1">
            <div className="dropdown d-inline-block">
              ...
              >
                ...
                <button
                  ...
                  onClick={() => handleSelectedCategoryChange(undefined)}
                >
                  <i className="far fa-fw fa-circle text-info opacity-50 me-1"></i>{" "}
                  All
                </button>
              </div>
            </div>
            <div className="dropdown d-inline-block">
              ...
              <div
                className={`dropdown-menu dropdown-menu-end ${
                  isSatusFilterOpen ? "show" : ""
                }`}
              >
                <button
                  className={`dropdown-item ${
                    selectedStatus === productStatus.AVAILABLE ? "active" : ""
                  }`}
                  onClick={() =>
                    handleSelectedStatusChange(productStatus.AVAILABLE)
                  }
                >
                  <i className="fa fa-fw fa-star text-warning me-1"></i>{" "}
                  available
                </button>
                <button
                  className={`dropdown-item ${
                    selectedStatus === productStatus.OUT_OF_STOCK
                      ? "active"
                      : ""
                  }`}
                  onClick={() =>
                    handleSelectedStatusChange(productStatus.OUT_OF_STOCK)
                  }
                >
                  <i className="fa fa-fw fa-exclamation-triangle text-danger me-1"></i>{" "}
                  Out of Stock
                </button>
                <div className="dropdown-divider"></div>
                <button
                  className={`dropdown-item ${
                    selectedStatus === undefined ? "active" : ""
                  }`}
                  onClick={() => handleSelectedStatusChange(undefined)}
                >
                  <i className="far fa-fw fa-circle text-info opacity-50 me-1"></i>{" "}
                  All
                </button>
