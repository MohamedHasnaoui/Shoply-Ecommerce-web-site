...
export default function AddProduct() {
  ...
  const handleSelectedCategoryChange = (
    category: { value: number | undefined; label?: string } | null
  ) => {
  ...
  const validate = () => {
    ...
    if (!productInput.reference)
      newErrors.reference = "Product reference is required";
    if (!productInput.price) newErrors.price = "Positive price is required";
    if (!productInput.quantity)
      newErrors.quantity = "Positive quantity is required";
    if (acceptedFiles.length === 0)
      newErrors.images = "You should at least drop one image";
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validate()) {
      ...
      try {
        const imagesUrls = await uploadCloudService.uploadImages(
          acceptedFiles,
          "images/products"
        );
          ...
          <div className="content content-top content-full text-center">
            <div className="py-3">
              ...
              <h2 className="h4 fw-normal text-white-75 mb-0">
                Add <span className="text-primary-light link-fx">New</span> One
                !
              </h2>
            </div>
          </div>
      ...
      <div className="bg-body-light border-bottom">
        <div className="content py-1 text-center">
          <nav className="breadcrumb bg-body-light py-2 mb-0">
            ...
            <a className="breadcrumb-item" href="be_pages_ecom_products.html">
              Products
            </a>
                  ...
                  <div className="block-options">
                    ...
                    >
                      {createProductLoading ? (
                        <span>
                          saving&nbsp;&nbsp;
                          <i className="fa fa-spinner fa-spin opacity-50 me-1"></i>
                        </span>
                      ) : (
                        <span>
                          save&nbsp;&nbsp;
                          <i className="fa fa-save opacity-50 me-1"></i>
                        </span>
                      )}
                    </button>
                  </div>
                ...
                <div className="block-content block-content-full">
                  ...
                  <div className="mb-4">
                    ...
                    <Select
                      ...
                      onChange={(c) => {
                        handleSelectedCategoryChange(c);
                      }}
                    />
                    {errors.category && (
                  ...
                  <div className="mb-4">
                    <label className="form-label" htmlFor="ecom-product-stock">
                      Stock
                    </label>
                    <div className="row">
                  ...
                  <div className="mb-4">
                    <label className="form-label" htmlFor="ecom-product-price">
                      Price
                    </label>
                    <div className="row">
                      <div className="col-sm-6">
