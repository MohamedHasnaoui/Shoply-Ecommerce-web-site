...
import RegisteredBuyersChart from "./RegisteredBuyersChart";
import RegisteredSellersChart from "./RegisteredSellersChart";
  ...
  return (
    <div>
        <div className="content-heading d-flex justify-content-between align-items-center">
            <span>
                Registrations <small className="d-none d-sm-inline">Overview</small>
            </span>
      ...
      <div className="row">
        ...
        <RegisteredBuyersChart period={selectedPeriod.periodFilter} />
        </div>
        {/* <!-- END Orders Earnings Chart --> */}

        {/* <!-- Orders Volume Chart --> */}
        <div className="col-md-6">
          <RegisteredSellersChart period={selectedPeriod.periodFilter} />
        </div>
