          ...
          <div className="space-x-1">
            ...
            <div className="dropdown d-inline-block">
              ...
              <div className={`dropdown-menu dropdown-menu-md dropdown-menu-end p-0 ${isInfoMenuOpen? "show":""}`} style={isInfoMenuOpen ? {position:"absolute",inset:"0px 0px auto auto",margin:0,transform:"translate3d(0px, 32.8889px, 0px)"}:{}}>
                ...
                <div className="p-2">
                  <button title="profile" className="dropdown-item d-flex align-items-center justify-content-between space-x-1 btn" onClick={()=>{props.openQuickAccess();setIsInfoMenuOpen(false)}} >
                    <span>Profile</span>
            ...
            {/* <!-- Toggle Side Overlay --> */}
            {/* <!-- Layout API, functionality initialized in Template._uiApiLayout() --> */}
            <button type="button" className="btn btn-sm btn-alt-secondary" onClick={()=>{props.openQuickAccess();setIsInfoMenuOpen(false)}} title="Open Quick Access">
