          ...
          <div className="dropdown d-inline-block">
            ...
            >
              <div className="px-3 py-2 bg-body-light rounded-top">
                <h5 className="fs-sm text-center mb-0">Color Themes</h5>
              </div>
              <div className="p-3">
              ...
              <div className="px-3 py-2 bg-body-light rounded-top">
                <h5 className="fs-sm text-center mb-0">Dark Mode</h5>
              </div>
              <div className="px-2 py-3">
                <div className="row g-1 text-center">
                  <div className="col-4">
                    <button
                      type="button"
                      className="dropdown-item mb-0 d-flex align-items-center gap-2"
                      data-toggle="layout"
              ...
              <div className="p-3 bg-body-light rounded-bottom">
                <div className="row g-sm text-center">
                  <div className="col-6">
                    <a
                      className="dropdown-item fs-sm fw-medium mb-0"
                  ...
                  <div className="col-6">
                    ...
                    >
                      <i className="fa fa-paint-brush opacity-50 me-1"></i>{" "}
                      Themes
                    </a>
                  </div>
                </div>
              ...
              style={
                isInfoMenuOpen
                  ? {
                      ...
                      margin: 0,
                      transform: "translate3d(0px, 32.8889px, 0px)",
                    }
                  : {}
              }
            >
              <div className="px-2 py-3 bg-body-light rounded-top">
                <h5 className="h6 text-center mb-0">John Smith</h5>
              </div>
              <div className="p-2">
                <a
