...
export type GetAdminHomeStatisticsQuery = {
  ...
  getAdminHomeStatistics: {
    __typename?: "AdminHomeStatistics";
    registeredSeller?: number | null;
    registeredBuyers?: number | null;
...
export type GetRegisteredUsersByPeriodQuery = {
  __typename?: "Query";
  getRegisteredUsersByPeriod: Array<number>;
};
...
export type GetFrequentBuyersQuery = {
  __typename?: "Query";
  getFrequentBuyers: Array<{
    __typename?: "frequentBuyersInfo";
    id: number;
    firstName: string;
    lastName: string;
...
export type UpdateUserBlockStatusMutation = {
  __typename?: "Mutation";
  updateUserBlockStatus: boolean;
};
...
export type UpdateProductDisableStatusMutation = {
  __typename?: "Mutation";
  updateProductDisableStatus: boolean;
};
...
export type VerificationEmailRequestMutation = {
  __typename?: "Mutation";
  VerificationEmailRequest: boolean;
};
...
export type GetOrderItemsForSellerQuery = {
  __typename?: "Query";
...
export type UpdateOrderItemStatusMutation = {
  __typename?: "Mutation";
...
export type GetRecievedOrderItemsStatisticsQuery = {
  __typename?: "Query";
  getRecievedOrderItemsStatistics: {
    __typename?: "OrderItemStatistics";
    countPending?: number | null;
    countCanceledOrFailed?: number | null;
...
export type GetGeneralOrderItemsStatisticsQuery = {
  __typename?: "Query";
  getRecievedOrderItemsStatistics: {
    __typename?: "OrderItemStatistics";
    countDelivered?: number | null;
...
export type GetEarningByPeriodQuery = {
  __typename?: "Query";
  getEarningByPeriod: Array<number>;
};
...
export type GetOrdersByPeriodQuery = {
  __typename?: "Query";
  getOrdersByPeriod: Array<number>;
};

export type CreatPaymentIntentMutationVariables = Exact<{
  [key: string]: never;
}>;

export type CreatPaymentIntentMutation = {
  __typename?: "Mutation";
  creatPaymentIntent: {
    __typename?: "PaymentSession";
    sessionUrl: string;
...
export type CreateProductMutation = {
  ...
  createProduct?: {
    ...
    price?: number | null;
    createdAt?: any | null;
    category?: { __typename?: "Category"; id?: number | null } | null;
  } | null;
};
...
export type GetAllMyProductsQuery = {
  __typename?: "Query";
  getAllMyProducts: {
    __typename?: "ProductListResult";
    count: number;
...
export type GetMyProductsStatisticsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetMyProductsStatisticsQuery = {
  __typename?: "Query";
...
export type GetSellerTopProductsQuery = {
  __typename?: "Query";
  getSellerTopProducts?: Array<{
    __typename?: "productAndNbOrders";
    totalSold: number;
    product: {
      __typename?: "Product";
...
export type GetCustomerPastOrderItemsQuery = {
  __typename?: "Query";
  getCustomerPastOrderItems?: Array<{
    __typename?: "OrderItem";
    id: number;
    quantity: number;
    price: number;
...
export type CancelShoppingCartMutationVariables = Exact<{
  [key: string]: never;
}>;

export type CancelShoppingCartMutation = {
  __typename?: "Mutation";
...
export type GetParamUploadImageQuery = {
  __typename?: "Query";
  getParamUploadImage: {
    __typename?: "UploadCloud";
    signature: string;
...
export type AddProductToWishListMutation = {
  ...
  addProductToWishList: {
    __typename?: "WishList";
    id: number;
    products?: Array<{ __typename?: "Product"; id: number } | null> | null;
  };
};
...
export type DeleteProductFromWishListMutation = {
  __typename?: "Mutation";
  deleteProductFromWishList: boolean;
};
...
export type GetFilteredWishListQuery = {
  __typename?: "Query";
  getFilteredWishList?: Array<{
    __typename?: "Product";
    id: number;
    name?: string | null;
    price?: number | null;
...
>(
  ...
  return useQuery<GetAdminHomeStatisticsQuery, TError, TData>(
    variables === undefined
      ? ["GetAdminHomeStatistics"]
      : ["GetAdminHomeStatistics", variables],
    fetcher<GetAdminHomeStatisticsQuery, GetAdminHomeStatisticsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetAdminHomeStatisticsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetRegisteredUsersByPeriodQuery, TError, TData>(
    ...
    >(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetRegisteredUsersByPeriodDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetBestSellersQuery, TError, TData>(
    variables === undefined
      ? ["GetBestSellers"]
      : ["GetBestSellers", variables],
    fetcher<GetBestSellersQuery, GetBestSellersQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
...
>(
  ...
  return useQuery<GetFrequentBuyersQuery, TError, TData>(
    variables === undefined
      ? ["GetFrequentBuyers"]
      : ["GetFrequentBuyers", variables],
    fetcher<GetFrequentBuyersQuery, GetFrequentBuyersQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetFrequentBuyersDocument,
      variables
    ),
    options
  );
...
>(
  ...
  >(
    ...
    (variables?: UpdateUserBlockStatusMutationVariables) =>
      fetcher<
        UpdateUserBlockStatusMutation,
        UpdateUserBlockStatusMutationVariables
      >(
...
>(
  ...
  >(
    ...
    (variables?: UpdateProductDisableStatusMutationVariables) =>
      fetcher<
        UpdateProductDisableStatusMutation,
        UpdateProductDisableStatusMutationVariables
      >(
        dataSource.endpoint,
        dataSource.fetchParams || {},
        UpdateProductDisableStatusDocument,
        variables
      )(),
    options
  );
...
>(
  ...
  >(
    ...
    (variables?: VerificationEmailRequestMutationVariables) =>
      fetcher<
        VerificationEmailRequestMutation,
        VerificationEmailRequestMutationVariables
      >(
        dataSource.endpoint,
        dataSource.fetchParams || {},
        VerificationEmailRequestDocument,
        variables
      )(),
    options
  );
...
export const useCreateCartItemMutation = <TError = unknown, TContext = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  options?: UseMutationOptions<
  ...
  >(
    ...
    (variables?: CreateCartItemMutationVariables) =>
      fetcher<CreateCartItemMutation, CreateCartItemMutationVariables>(
        dataSource.endpoint,
        dataSource.fetchParams || {},
...
>(
  ...
  return useQuery<GetOrderItemsForSellerQuery, TError, TData>(
    ...
    fetcher<GetOrderItemsForSellerQuery, GetOrderItemsForSellerQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetOrderItemsForSellerDocument,
      variables
    ),
    options
  );
...
>(
  ...
  >(
    ["UpdateOrderItemStatus"],
    (variables?: UpdateOrderItemStatusMutationVariables) =>
      fetcher<
        UpdateOrderItemStatusMutation,
        UpdateOrderItemStatusMutationVariables
      >(
...
>(
  ...
  return useQuery<GetRecievedOrderItemsStatisticsQuery, TError, TData>(
    variables === undefined
      ? ["GetRecievedOrderItemsStatistics"]
      : ["GetRecievedOrderItemsStatistics", variables],
    fetcher<
    ...
    >(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetRecievedOrderItemsStatisticsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetGeneralOrderItemsStatisticsQuery, TError, TData>(
    variables === undefined
      ? ["GetGeneralOrderItemsStatistics"]
      : ["GetGeneralOrderItemsStatistics", variables],
    fetcher<
    ...
    >(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetGeneralOrderItemsStatisticsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetEarningByPeriodQuery, TError, TData>(
    variables === undefined
      ? ["GetEarningByPeriod"]
      : ["GetEarningByPeriod", variables],
    fetcher<GetEarningByPeriodQuery, GetEarningByPeriodQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetEarningByPeriodDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetOrdersByPeriodQuery, TError, TData>(
    variables === undefined
      ? ["GetOrdersByPeriod"]
      : ["GetOrdersByPeriod", variables],
    fetcher<GetOrdersByPeriodQuery, GetOrdersByPeriodQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetOrdersByPeriodDocument,
      variables
    ),
    options
  );
...
>(
  ...
  options?: UseMutationOptions<
    ...
    TError,
    CreatPaymentIntentMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >(
    ["CreatPaymentIntent"],
    (variables?: CreatPaymentIntentMutationVariables) =>
      fetcher<CreatPaymentIntentMutation, CreatPaymentIntentMutationVariables>(
        dataSource.endpoint,
        dataSource.fetchParams || {},
        CreatPaymentIntentDocument,
        variables
      )(),
    options
  );
...
>(
  ...
  return useQuery<VerifyPaymentQuery, TError, TData>(
    ...
    fetcher<VerifyPaymentQuery, VerifyPaymentQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
...
>(
  ...
  return useQuery<GetAllMyProductsQuery, TError, TData>(
    variables === undefined
      ? ["GetAllMyProducts"]
      : ["GetAllMyProducts", variables],
    fetcher<GetAllMyProductsQuery, GetAllMyProductsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetAllMyProductsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetMyProductsStatisticsQuery, TError, TData>(
    variables === undefined
      ? ["GetMyProductsStatistics"]
      : ["GetMyProductsStatistics", variables],
    fetcher<
    ...
    >(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetMyProductsStatisticsDocument,
      variables
    ),
    options
  );
...
export const useRemoveProductMutation = <TError = unknown, TContext = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  options?: UseMutationOptions<
  ...
  >(
    ...
    (variables?: RemoveProductMutationVariables) =>
      fetcher<RemoveProductMutation, RemoveProductMutationVariables>(
        dataSource.endpoint,
        dataSource.fetchParams || {},
...
>(
  ...
  return useQuery<GetSellerTopProductsQuery, TError, TData>(
    ...
    fetcher<GetSellerTopProductsQuery, GetSellerTopProductsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetSellerTopProductsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetCustomerInfoQuery, TError, TData>(
    ...
    fetcher<GetCustomerInfoQuery, GetCustomerInfoQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
...
>(
  ...
  return useQuery<GetCustomerPastOrderItemsQuery, TError, TData>(
    ...
    >(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetCustomerPastOrderItemsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  return useQuery<GetShoppingCartQuery, TError, TData>(
    variables === undefined
      ? ["GetShoppingCart"]
      : ["GetShoppingCart", variables],
    fetcher<GetShoppingCartQuery, GetShoppingCartQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
...
>(
  ...
  options?: UseMutationOptions<
    ...
    TError,
    CancelShoppingCartMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >(
    ["CancelShoppingCart"],
    (variables?: CancelShoppingCartMutationVariables) =>
      fetcher<CancelShoppingCartMutation, CancelShoppingCartMutationVariables>(
        dataSource.endpoint,
        dataSource.fetchParams || {},
        CancelShoppingCartDocument,
        variables
      )(),
    options
  );
...
>(
  ...
  return useQuery<GetParamUploadImageQuery, TError, TData>(
    ...
    fetcher<GetParamUploadImageQuery, GetParamUploadImageQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetParamUploadImageDocument,
      variables
    ),
    options
  );
...
export const useGetWishListQuery = <TData = GetWishListQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  ...
  return useQuery<GetWishListQuery, TError, TData>(
    ...
    fetcher<GetWishListQuery, GetWishListQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetWishListDocument,
      variables
  ...
  >(
    ...
    (variables?: DeleteProductFromWishListMutationVariables) =>
      ...
      >(
        dataSource.endpoint,
        dataSource.fetchParams || {},
        DeleteProductFromWishListDocument,
        variables
      )(),
    options
  );
...
>(
  ...
  return useQuery<GetFilteredWishListQuery, TError, TData>(
    variables === undefined
      ? ["GetFilteredWishList"]
      : ["GetFilteredWishList", variables],
    fetcher<GetFilteredWishListQuery, GetFilteredWishListQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetFilteredWishListDocument,
      variables
    ),
    options
  );
