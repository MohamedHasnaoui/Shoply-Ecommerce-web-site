...
> = {
  ...
  >;
  addProductToCategory?: Resolver<
    ResolversTypes["ResponseMessage"],
    ParentType,
    ContextType,
    RequireFields<MutationAddProductToCategoryArgs, "productId">
  >;
...
> = {
  ...
  product?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryProductArgs, "productId">
  >;
  productsByCategory?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Product"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryProductsByCategoryArgs, "categoryName">
  >;
};

export type ResponseMessageResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["ResponseMessage"] = ResolversParentTypes["ResponseMessage"]
> = {
