...
export type AdminHomeStatisticsResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["AdminHomeStatistics"] = ResolversParentTypes["AdminHomeStatistics"]
> = {
  ...
  registeredBuyers?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  registeredSeller?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
...
> = {
  VerificationEmailRequest?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationVerificationEmailRequestArgs, "email">
  >;
  addProductToWishList?: Resolver<
    ResolversTypes["WishList"],
    ParentType,
    ContextType,
    RequireFields<MutationAddProductToWishListArgs, "productId">
  >;
  addResetPasswordRequest?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationAddResetPasswordRequestArgs, "email">
  >;
  cancelShoppingCart?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
  creatCartItem?: Resolver<
    ResolversTypes["CartItem"],
    ParentType,
    ContextType,
    RequireFields<MutationCreatCartItemArgs, "input">
  >;
  creatPaymentIntent?: Resolver<
    ResolversTypes["PaymentSession"],
    ParentType,
    ContextType
  >;
  ...
  createOrder?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateOrderArgs, "paymentId">
  >;
  ...
  >;
  deleteProductFromWishList?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteProductFromWishListArgs, "productId">
  >;
  ...
  >;
  incrementQuantity?: Resolver<
    Maybe<ResolversTypes["Product"]>,
    ParentType,
    ContextType,
    RequireFields<MutationIncrementQuantityArgs, "addedQte" | "productId">
  >;
  removeCartItem?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveCartItemArgs, "idCartItem">
  >;
  removeProduct?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveProductArgs, "productId">
  >;
  ...
  updateCartItem?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateCartItemArgs, "input">
  >;
  ...
  >;
  updateOrderItemStatus?: Resolver<
    ResolversTypes["OrderItem"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateOrderItemStatusArgs, "orderItemId" | "status">
  >;
  ...
  >;
  updateProductDisableStatus?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
  ...
  updateReview?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateReviewArgs, "input">
  >;
  updateUser?: Resolver<
    ResolversTypes["User"],
    ParentType,
  ...
  >;
  updateUserBlockStatus?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateUserBlockStatusArgs, "isBlocked" | "userId">
  >;
  verifyEmail?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationVerifyEmailArgs, "email" | "token">
  >;
};
...
export type OrderItemStatisticsResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["OrderItemStatistics"] = ResolversParentTypes["OrderItemStatistics"]
> = {
  all?: Resolver<Maybe<ResolversTypes["Int"]>, ParentType, ContextType>;
  countCanceledOrFailed?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  countDelivered?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  countPending?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
...
export type OrderItemsListResultResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["OrderItemsListResult"] = ResolversParentTypes["OrderItemsListResult"]
> = {
...
export type PaymentSessionResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["PaymentSession"] = ResolversParentTypes["PaymentSession"]
> = {
...
export type PaymentVerificationResultResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["PaymentVerificationResult"] = ResolversParentTypes["PaymentVerificationResult"]
> = {
...
export type ProductListResultResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["ProductListResult"] = ResolversParentTypes["ProductListResult"]
> = {
  count?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  products?: Resolver<
...
export type ProductsStatisticsResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["ProductsStatistics"] = ResolversParentTypes["ProductsStatistics"]
> = {
...
> = {
  currentUser?: Resolver<
    ...
    ContextType
  >;
  getAdminHomeStatistics?: Resolver<
    ResolversTypes["AdminHomeStatistics"],
    ParentType,
    ContextType,
    Partial<QueryGetAdminHomeStatisticsArgs>
  >;
  getAllCartItems?: Resolver<
  ...
  getAllCategories?: Resolver<
    ...
    ContextType
  >;
  getAllMyProducts?: Resolver<
    ResolversTypes["ProductListResult"],
    ParentType,
    ContextType,
    Partial<QueryGetAllMyProductsArgs>
  >;
  getAllProducts?: Resolver<
    ResolversTypes["ProductListResult"],
    ParentType,
    ContextType,
    Partial<QueryGetAllProductsArgs>
  >;
  getBestSellers?: Resolver<
    Array<ResolversTypes["bestSellerInfo"]>,
    ParentType,
    ContextType,
    Partial<QueryGetBestSellersArgs>
  >;
  getCartItem?: Resolver<
    ResolversTypes["CartItem"],
    ParentType,
    ContextType,
    RequireFields<QueryGetCartItemArgs, "idCartItem">
  >;
  ...
  >;
  getCustomerPastOrderItems?: Resolver<
    Maybe<Array<ResolversTypes["OrderItem"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetCustomerPastOrderItemsArgs, "customerId">
  >;
  getEarningByPeriod?: Resolver<
    Array<ResolversTypes["Float"]>,
    ParentType,
    ContextType,
    Partial<QueryGetEarningByPeriodArgs>
  >;
  getFilteredWishList?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Product"]>>>,
    ParentType,
    ContextType,
    Partial<QueryGetFilteredWishListArgs>
  >;
  getFrequentBuyers?: Resolver<
    Array<ResolversTypes["frequentBuyersInfo"]>,
    ParentType,
    ContextType,
    Partial<QueryGetFrequentBuyersArgs>
  >;
  getMyOrders?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Order"]>>>,
    ParentType,
    ContextType,
    Partial<QueryGetMyOrdersArgs>
  >;
  getMyProductsStatistics?: Resolver<
    ResolversTypes["ProductsStatistics"],
    ParentType,
    ContextType
  >;
  getOrder?: Resolver<
  ...
  getOrderItem?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetOrderItemArgs, "OrderItemId">
  >;
  getOrderItemsByOrderId?: Resolver<
    Array<Maybe<ResolversTypes["OrderItem"]>>,
    ParentType,
    ContextType,
    Partial<QueryGetOrderItemsByOrderIdArgs>
  >;
  getOrderItemsForSeller?: Resolver<
    ResolversTypes["OrderItemsListResult"],
    ParentType,
    ContextType,
    RequireFields<QueryGetOrderItemsForSellerArgs, "input">
  >;
  getOrdersByPeriod?: Resolver<
    Array<ResolversTypes["Float"]>,
    ParentType,
    ContextType,
    Partial<QueryGetOrdersByPeriodArgs>
  >;
  getParamUploadImage?: Resolver<
    ResolversTypes["UploadCloud"],
    ParentType,
    ContextType,
    RequireFields<QueryGetParamUploadImageArgs, "folder">
  >;
  getProduct?: Resolver<
  ...
  >;
  getRecievedOrderItemsStatistics?: Resolver<
    ResolversTypes["OrderItemStatistics"],
    ParentType,
    ContextType,
    Partial<QueryGetRecievedOrderItemsStatisticsArgs>
  >;
  getRegisteredUsersByPeriod?: Resolver<
    Array<ResolversTypes["Int"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetRegisteredUsersByPeriodArgs, "role">
  >;
  getReviewsByProductId?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Review"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetReviewsByProductIdArgs, "productId">
  >;
  getSellerTopProducts?: Resolver<
    Maybe<Array<ResolversTypes["productAndNbOrders"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetSellerTopProductsArgs, "nbProduct">
  >;
  getShoppingCart?: Resolver<
    Maybe<ResolversTypes["ShoppingCart"]>,
    ParentType,
    ContextType
  >;
  getTopSellingProducts?: Resolver<
    Maybe<Array<ResolversTypes["productAndNbOrders"]>>,
    ParentType,
    ContextType,
    Partial<QueryGetTopSellingProductsArgs>
  >;
  ...
  verifyPayment?: Resolver<
    ResolversTypes["PaymentVerificationResult"],
    ParentType,
    ContextType,
    RequireFields<QueryVerifyPaymentArgs, "sessionId">
  >;
};
...
export type UploadCloudResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["UploadCloud"] = ResolversParentTypes["UploadCloud"]
> = {
...
export type BestSellerInfoResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["bestSellerInfo"] = ResolversParentTypes["bestSellerInfo"]
> = {
...
export type FrequentBuyersInfoResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["frequentBuyersInfo"] = ResolversParentTypes["frequentBuyersInfo"]
> = {
  firstName?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  lastName?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  nbPlacedOrders?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  nbPurchasedProducts?: Resolver<
    ResolversTypes["Int"],
    ParentType,
    ContextType
  >;
...
export type ProductAndNbOrdersResolvers<
  ContextType = MyContext,
  ParentType extends ResolversParentTypes["productAndNbOrders"] = ResolversParentTypes["productAndNbOrders"]
> = {
  product?: Resolver<ResolversTypes["Product"], ParentType, ContextType>;
